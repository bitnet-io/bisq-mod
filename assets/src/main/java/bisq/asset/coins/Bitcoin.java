...
//import org.libdohj.params.MainNetParams;
//import org.libdohj.params.RegTestParams;
//import org.libdohj.params.TestNet3Params;

public abstract class Bitcoin extends Coin {

    public Bitcoin(Network network, NetworkParameters networkParameters) {
        super("Bitnet", "BIT", new BitcoinAddressValidator(networkParameters), network);
    }
