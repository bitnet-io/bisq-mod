...
abstract class MempoolFeeRateProvider extends FeeRateProvider {
    ...
    protected FeeRate doGet() {
        ...
        return new FeeRate("BIT", MIN_FEE_RATE_FOR_TRADING, MIN_FEE_RATE_FOR_WITHDRAWAL, Instant.now().getEpochSecond());
    }
    ...
    private FeeRate getEstimatedFeeRate() {
        ...
        return new FeeRate("BIT", estimatedFeeRate, minimumFee, Instant.now().getEpochSecond());
    }
